    ...
    const handleSubmit = async ()=>{
        try {
            ...
            if(data.success){
                ...
                // Navigate to the correct page using the new show's ID
                // We assume your backend returns the new show's ID in the response.
                // If not, you will need to modify the backend.
                if (data.newShowId) {
                    navigate(`/movies/${data.newShowId}`);
                }
